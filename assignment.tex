...
Diese Ergebnisse wurden mit Hilfe der \emph{SHARPE} Skripten \Fref{sec:calc_mttf_simple},
...
Für die Programmsequenzen, die für die Berechnung von $\alpha_s$ verwenden wurde, siehe \Fref{sec:calc_aval_simple}.
...
Für die \emph{SHARPE} Skripten siehe \Fref{sec:calc_aval_redundant}.\\

\section{Diskussion}
\subsection{MTTF}
Beim Vergleich der MTTF Graphen (siehe \Fref{fig:mttf_result}), wurde festgestellt, dass sich die Ausfallwahrscheinlichkeit der Redundanten Variante mit Reparatur deutlich von den beiden anderen Systemen abhebt. \\
